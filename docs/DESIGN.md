# Architecture Decision Record - Infrastructure drift detector

**Date:**
**Status:** Accepted
**Authors:** Nisha Gupta, Deepak

## Decision

Implement Infrastructure drift detector using industry-standard patterns appropriate for python and our platform requirements.
